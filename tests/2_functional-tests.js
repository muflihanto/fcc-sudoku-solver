...
suite("Functional Tests", () => {
  // TODO: Solve a puzzle with valid puzzle string: POST request to /api/solve
  // TODO: Solve a puzzle with missing puzzle string: POST request to /api/solve
  // TODO: Solve a puzzle with invalid characters: POST request to /api/solve
  // TODO: Solve a puzzle with incorrect length: POST request to /api/solve
  // TODO: Solve a puzzle that cannot be solved: POST request to /api/solve
